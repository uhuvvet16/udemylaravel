                    ...
                    <div class="sngl-top">
                                ...
                                <ul class="slides">
                                    <li data-thumb="{{ asset(\App\Helper\mHelper::largeImage($data[0]['image'])) }}">
                                        <div class="thumb-image"> <img
                                                src="{{ asset(\App\Helper\mHelper::largeImage($data[0]['image'])) }}"
                        ...
                        <div class="col-md-8 single-top-right">
                            <div class="single-para simpleCart_shelfItem">
                                ...
                                <div class="available">
                                    <ul>
                                        {{-- <li>Kategori : {{\App\Models\Kategoriler::getField($data[0]['kategoriid'],'name')}} </li>
                                        <li>Yayın Evi : {{\App\Models\YayinEvi::getField($data[0]['yayineviid'],'name')}} </li>
                                        <li class="size-in">Yazar: {{\App\Models\Yazarlar::getField($data[0]['yazarid'],'name')}} </li> --}}
                                        <div class="clearfix"> </div>
                                    </ul>
                                </div>
                                <ul class="tag-men">
                                    <li><span>Kategori</span>
                                        <span class="women1">: {{\App\Models\Kategoriler::getField($data[0]['kategoriid'],'name')}}</span>
                                    </li>
                                    <li><span>Yayın Evi</span>
                                        <span class="women1">: {{\App\Models\YayinEvi::getField($data[0]['yayineviid'],'name')}}</span>
                                    </li>
                                    <li><span>Yazar</span>
                                        <span class="women1">: {{\App\Models\Yazarlar::getField($data[0]['yazarid'],'name')}}</span>
                                    </li>
                                </ul>
